...
public class CustomProcessDiagramGenerator extends DefaultProcessDiagramGenerator {
    ...
    static {
        new CustomProcessDiagramCanvas(10, 10, 0, 0, "png");
    }

    public CustomProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType,
                                                             List<String> highLightedActivities, List<String> highLightedFlows, boolean drawSequenceFlowNameWithNoLabelDI,/*, String activityFontName,
                                                             String labelFontName, String annotationFontName, ClassLoader customClassLoader, */
                                                             double scaleFactor, Color[] colors, Set<String> currIds) {
        ...
        for (Pool pool : bpmnModel.getPools()) {
            ...
            processDiagramCanvas.drawPoolOrLane(pool.getName(), graphicInfo, 1.0D);
        }
        ...
        for (Process process : bpmnModel.getProcesses()) {
            for (Lane lane : process.getLanes()) {
                ...
                processDiagramCanvas.drawPoolOrLane(lane.getName(), graphicInfo, 1.0D);
            }
        }
    ...
    private void drawActivity(CustomProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode,
...
//          }else {//解决流程图连线名称不显示的BUG
                ...
                processDiagramCanvas.drawLabel(highLighted, sequenceFlow.getName(), lineCenter, true);
//          }
            }
        }
    ...
    public InputStream generateDiagram(BpmnModel bpmnModel, String imageType, List<String> highLightedActivities,
        ...
        CustomProcessDiagramCanvas customProcessDiagramCanvas = generateProcessDiagram(bpmnModel, imageType, highLightedActivities, highLightedFlows,
                drawSequenceFlowNameWithNoLabelDI, scaleFactor, null, null);
