package com.liujianan.cube.flowable.constant;

/**
 * @version v1.0
 * @ProjectName: cube-flowable
 * @ClassName: FlowableConstant
 * @Description: 常量类
 * @Author: 风清扬 [刘佳男]
...
public class FlowableConstant {
     ...
     * 状态 待提交申请
     */
    public final static String STATUS_TO_APPLY = "0";
    /**
     * 状态 处理中
     */
    public final static String STATUS_DEALING = "1";
    /**
     * 状态 处理结束
     */
    public final static String STATUS_FINISH = "2";
    /**
     * 状态 已撤回
     */
    public final static String STATUS_CANCELED = "3";

    /**
     * 结果 待提交
     */
    public final static String RESULT_TO_SUBMIT = "0";

    /**
     * 结果 处理中
     */
    public final static String RESULT_DEALING = "1";

    /**
     * 结果 通过
     */
    public final static String RESULT_PASS = "2";

    /**
     * 结果 驳回
     */
    public final static String RESULT_FAIL = "3";
     ...
     * 结果 删除
     */
    public final static String RESULT_DELETED = "5";

    /**
     * 候选
     */
    public final static String EXECUTOR_candidate = "candidate";
}
